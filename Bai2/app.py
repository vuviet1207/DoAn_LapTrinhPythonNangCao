...
class DatabaseApp:
    ...
    def create_login_widgets(self):
        ...
        tk.Button(connection_frame, text="Connect", command=lambda: self.connect_db(self.db_name.get(),self.user.get(),self.password.get(),self.host.get(),self.port.get())).grid(row=5, columnspan=2, pady=10)
